...
["48", "Howard", "Littiejohn", "howard.littlejohn@gmail.com", "07840938530"],
["84", "Isabel", "Lowe", "ismaclowe@aol.com", " "],
["52", "Cathy", "Mangles", "c.mangles51@icloud.com", "01446772316"],
["53", "Carol", "Marchat", "crmcourt@hotmail.com ", "01446773355"],
...
["83", "Wyn", "Silman", "winifred.silman52@icloud.com", "01446793534"],
...
function myCalc(lbl){
    ...
    if (membership[i][1].concat(" ",membership[i][2])==lbl){
    person=membership[i];}
    }
return person;  
}
